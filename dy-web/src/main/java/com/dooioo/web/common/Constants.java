...
public class Constants {
    ...
    public static final String DAO_QUERY_First = "queryFirst";
    public static final String DAO_COUNT = "count";
    public static final String DAO_COUNT_2 = "count2";
    public static final String DAO_QUERY = "query";
    public static final String DAO_QUERY_FOR_PAGINATE = "queryForPaginate";
    public static final String DAO_QUERY_FOR_PAGINATE_2 = "queryForPaginate2";
    @Deprecated
