package com.dooioo.web.converter;
...
/**
 * @see {@link org.springframework.http.converter.json MappingJacksonHttpMessageConverter}
 *  @see {@link org.springframework.http.converter.StringHttpMessageConverter}
 */
public class DyMappingJacksonHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
     ...
     */
    public DyMappingJacksonHttpMessageConverter() {
    ...
    protected void writeInternal(Object object, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        if(object instanceof String){
            ...
            FileCopyUtils.copy(object.toString(), new OutputStreamWriter(outputMessage.getBody(), charset));
        }else{
